...
struct MyObj1 {
  ...
  using ListOfAttributeMetaClasses =
      List<attributes::s, attributes::i, attributes::o>;
};
}  // namespace meta
}  // namespace example_com_include1_schema

template <>
struct meta::meta_of<example_com_include1_schema::MyObj1>
    : std::type_identity<example_com_include1_schema::meta::MyObj1> {};
